...
public class FrmConnexion extends javax.swing.JFrame {
    ...
    private void btnConnecterMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnConnecterMouseClicked
        ...
        {
        // TOUT EST OK : l'utilisateur à bien saisi tous les nombres
            User userConnecte =fm.VerifierLogin(txtLogin.getText(), txtMdp.getText());
            if(userConnecte == null)
            {
                lblErreur.setText("Identifiants incorrects");
            }
            else if(userConnecte.getStatutUser().compareTo("user")==0)
            {
                FrmUser frm = new FrmUser(userConnecte);
                frm.setVisible(true);
            }
            else
            {
